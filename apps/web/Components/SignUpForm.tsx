...
import { signUpSchema , TsignUpSchema } from "../constants/zodTypes";
import { z } from "zod";
      ...
      />
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input placeholder="Enter your Password" {...field} className=" h-10" />
            </FormControl>
            {/* <FormDescription className=" text-white">
              This is your public display name.
            </FormDescription> */}
      ...
      />
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input placeholder="Enter your Confirm Password" {...field} className=" h-10"/>
            </FormControl>
            {/* <FormDescription className=" text-white">
              This is your public display name.
            </FormDescription> */}
